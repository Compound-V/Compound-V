...
```shell-session
sanjayrcse@htb[/htb]$ apropos <keyword>
```
...
```shell-session
sanjayrcse@htb[/htb]$ apropos sudo
...
```shell-session
sanjayrcse@htb[/htb]$ ssh htb-student@[IP address]
```
